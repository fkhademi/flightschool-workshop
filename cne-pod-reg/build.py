        ...
        if pod_id <= max_num_pods:
            ...
            <div class="col-sm-12">
                ...
                <div class="card-body">
                    ...
                    <a target="_blank" rel="noopener noreferrer" href="https://avx-flightschool.s3.us-east-1.amazonaws.com/FlightSchool-Lab-Guide.pdf" class="btn btn-primary">Open Lab Guide</a>
                </div>
                </div>
            </div>
